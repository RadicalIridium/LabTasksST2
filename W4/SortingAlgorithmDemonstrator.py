"""
A Sorting Algorithm Demonstrator that allows users to visualize and compare different sorting algorithms.
The 'inital' code is provided by the UNI of Canberra unit Sotfware Tech 2.
At the time of writing this, the code appears to be complete and functional, I'm not sure what is expected to be added.
"""

# Sorting Algorithms Demo
# Animation speeds (milliseconds)
SPEEDS = {"Very Slow": 1000, "Slow": 500, "Medium": 100, "Fast": 50, "Very Fast": 10}
...
class SortingAlgorithms:
    ...
    def partition(low, high):
        ...
        if low < high:
            ...
            self.visualizer.mark_sorted(high)
    ...
    def merge_sort(self, left=None, right=None):
        ...
        if left < right:
            ...
            self.visualizer.mark_sorted(right)
