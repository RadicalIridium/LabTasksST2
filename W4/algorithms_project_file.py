...
#print(f"Linear search execution time: {linear_time:.6f} seconds for length {len(sorted_list)}")
#print(f"Binary search execution time: {binary_time:.6f} seconds for length {len(sorted_list)}")
...
#print("Bubble Sorted array:", sorted_list)
...
#print("Insertion Sorted array:", sorted_list)
