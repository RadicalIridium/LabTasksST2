...
# Singly Linked List Node and Class, From (linked_list_practice.py)
class Node:
...
class SingleLinkedListVisualizer:
    ...
    def draw_list(self, highlight_index=None):
        ...
        for i in range(len(centers) - 1):
            ...
            """
            Removed the arrow pointing backwards, to help create a single linked list, as per task.
...
if __name__ == "__main__":
    root = tk.Tk()
    app = SingleLinkedListVisualizer(root)
